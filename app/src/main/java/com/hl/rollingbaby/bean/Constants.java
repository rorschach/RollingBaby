...
public interface Constants {
    ...
    public static final String CURRENT_HUMIDITY_VALUE = "HUMIDITY";
    public static final String CURRENT_SOUND_MODE = "SOUND";
    public static final String CURRENT_SWING_MODE = "SWING";

    public static final String CLOSE = "CLOSE";
    public static final String MUSIC = "MUSIC";
    public static final String STORY = "STORY";
    public static final String SLLEP = "SLLEP";
    public static final String ENTERTAINMENT = "ENTERTAINMENT";
    public static final int DEFAULT_TEMPERATURE = 36;
    public static final int DEFAULT_HUMIDITY = 40;

    public static final String HEATING_STATE = "HEATING_STATE";//boolean
    public static final String HUMIDITYTING_STATE = "HUMIDITYTING_STATE";//boolean
    public static final String PLAY_STATE = "PLAY_STATE";//int
//    public static final int SWING_STATE = 0;
    ...
    public static final String HEATING_CLOSE = TEMPERATURE_TAG + 0;
    public static final String HEATING_OPEN = TEMPERATURE_TAG + 1;

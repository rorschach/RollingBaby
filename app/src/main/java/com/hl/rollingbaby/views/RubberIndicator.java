...
public class RubberIndicator extends RelativeLayout {
    ...
    private com.hl.rollingbaby.views.CircleView mLargeCircle;
    private com.hl.rollingbaby.views.CircleView mSmallCircle;
    private com.hl.rollingbaby.views.CircleView mOuterCircle;
    private com.hl.rollingbaby.views.CircleView[] mSmallCircleViews;
    ...
    private void init() {
        ...
        mOuterCircle = (com.hl.rollingbaby.views.CircleView) rootView.findViewById(R.id.outer_circle);
    ...
    public void setCount(int count) {
        ...
        int size = count - 1;
        mSmallCircleViews = new com.hl.rollingbaby.views.CircleView[size];
        for (int i = 0; i < size; i++) {
            com.hl.rollingbaby.views.CircleView circleView = createCircleView(CIRCLE_TYPE_SMALL);
            mContainer.addView(circleView);
            mSmallCircleViews[i] = circleView;
        }
    }

    private com.hl.rollingbaby.views.CircleView createCircleView(int type) {
        com.hl.rollingbaby.views.CircleView circleView = new com.hl.rollingbaby.views.CircleView(getContext());
